...
public class NotePad extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        bLoad.setIcon(new javax.swing.ImageIcon(getClass().getResource("/org/ieselcaminas/notepad/document.png"))); // NOI18N
        bLoad.setText("Load");
        ...
        miSave.setText("Guardar Archivo");
    ...
    if(returnVal == JFileChooser.APPROVE_OPTION) {
       File file = chooser.getSelectedFile();
        try {
            ...
            JOptionPane.showMessageDialog(this, "Error reading file", "Erro", JOptionPane.ERROR_MESSAGE);
        }
